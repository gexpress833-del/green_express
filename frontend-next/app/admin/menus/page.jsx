              ...
              <div key={m.id} className="card border border-white/10 hover:border-gold/30 transition-all">
                <div className="flex flex-col">
                  ...
                  <div className="flex-shrink-0 mb-3">
                    {m.image ? (
                      <img src={getBlobImageUrl(m.image, 200)} alt={m.title} className="w-full h-40 object-cover rounded-lg" />
                    ) : (
                      <div className="w-full h-40 bg-gradient-to-br from-white/5 to-white/10 rounded-lg flex items-center justify-center">
